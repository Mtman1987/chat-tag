...
export const GAME_HUB_CATALOG: GameHubGame[] = [
  ...
  },
  {
    ...
    howToPlay: 'Request a theme with !mosaic owl, open one of four boards with spmt view 1, then paint naturally with commands such as spmt D12Y or spmt yellow D12.',
    runtime: 'board-state',
    status: 'prototype-ready',
    category: 'creative',
    commands: [
