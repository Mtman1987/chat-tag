...
- `NEBULA_ARCADE_WEBHOOK_NAME` / `NEBULA_ARCADE_AVATAR_URL` if customized. The older avatar variables remain supported, but the retired Chat Tag name can no longer override public Nebula Arcade branding.
