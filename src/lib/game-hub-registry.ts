...
export const BINGO_GAME: GameHubGame = {
  ...
  name: 'Bingo',
  shortName: 'Bingo',
  description: 'The shared community bingo card built from moments spotted across participating streams.',
  howToPlay: 'Join Bingo, watch participating community streams, and claim an eligible square when you spot its moment. The shared card tracks claims and completed lines.',
  runtime: 'native',
  status: 'live',
  category: 'party',
  commands: [],
