      ...
      <section className="cosmic-card space-y-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <span className="rounded-full border border-cyan-300/20 bg-cyan-300/10 px-3 py-1.5 text-xs font-bold uppercase tracking-wide text-cyan-100">
            {game.status === 'live' ? 'Live' : 'Games Hub'}
          </span>
        </div>
        ...
        <section className="rounded-2xl border border-white/10 bg-black/25 p-5">
          ...
          <dl className="mt-3 grid gap-3 text-sm sm:grid-cols-3">
            <div><dt className="text-slate-500">Engine</dt><dd className="text-slate-200">{game.runtime}</dd></div>
            <div><dt className="text-slate-500">Overlay</dt><dd className="text-slate-200">{game.overlayAspect}</dd></div>
